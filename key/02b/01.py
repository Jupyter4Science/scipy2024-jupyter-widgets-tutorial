...
def on_window_size_change(change):
    ...
    original_df['Savitzky-Golay'] = savgol_filter(original_df['Temperature'], change['new'], poly_order.value) # original_df['Savitzky-Golay'] = savgol_filter(original_df['Temperature'], window_size, poly_order)
